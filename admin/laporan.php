...
<div class="container">
    ...
    if (isset($_GET['tgl_dari']) && isset($_GET['tgl_sampai'])) {
        ...
        echo "Dari Tanggal: " . $dari . " Sampai Tanggal: " . $sampai . "<br>"; // Debug code
    ?>
        <div class="panel">
            <div class="panel-heading">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <?php
                    include '../koneksi.php';
                    $query = "SELECT * FROM pelanggan, transaksi WHERE transaksi_pelanggan=pelanggan_id AND DATE(transaksi_tgl) >= '$dari' AND DATE(transaksi_tgl) <= '$sampai' ORDER BY transaksi_id DESC";
                    $data = mysqli_query($koneksi, $query);
                    if (!$data) {
                        echo "Error: " . mysqli_error($koneksi); // Debug code
                    }
                    $no = 1;
